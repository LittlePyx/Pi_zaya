...
中文翻译:
**图1。** 给定单帧压缩图像，我们的方法能够恢复其底层的3D场景表示。借助NeRF强大的新视角图像合成能力，我们可仅从*单次测量*中高质量地渲染出多视角一致的图像。
```
...
- gate[answer]: `PASS`
- gate[locate]: `PASS`
- locate_matched_headings: `['SCINeRF: Neural Radiance Fields from a Snapshot Compressive Image / 4. Experiments / 4.1. Experimental Setup', 'SCINeRF: Neural Radiance Fields from a Snapshot Compressive Image / 4. Experiments / 4.1. Experimental Setup']`
- locate_matched_anchors: `['We train our model for 100–200K iterations, with 5000 rays as batch size.', 'We train our model for 100–200K iterations, with 5000 rays as batch size.']`
- gate[quality]: `PASS`
- gate[structured_markers]: `PASS`
- reason: `none`
- answer_preview:
...
该句即 *Figure 3* 的 caption 内容，可直接定位至 Figure 3 的图注。
