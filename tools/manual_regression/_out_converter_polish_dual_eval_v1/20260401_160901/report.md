...
```text
The paper cites [4], [20], [49] for this point.
...
Key components listed in this caption are:
...
*Source: output.pdf, Fig. 3. Figure 3*
```
...
```text
The paper cites [33], [34], [35], [36] for this point.
