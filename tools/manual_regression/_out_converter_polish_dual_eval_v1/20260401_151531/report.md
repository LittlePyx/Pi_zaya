...
|---|---|---|---|---|---|---|---|---|---|
| SCINERF2024_V7_CITATION_ADMM | cvpr_2024_scinerf_polish_v7 | citation_lookup | PASS | PASS | PASS | PASS | n/a | n/a | n/a |
| SCINERF2024_V7_METHOD_IMPL_ITER_BATCH | cvpr_2024_scinerf_polish_v7 | method | PASS | PASS | n/a | PASS | n/a | n/a | n/a |
| SCINERF2024_V7_FIG3_CAPTION_COMPONENTS | cvpr_2024_scinerf_polish_v7 | figure_walkthrough | PASS | PASS | n/a | PASS | n/a | n/a | PASS |
| SCINERF2024_V7_FIG4_SCENES | cvpr_2024_scinerf_polish_v7 | figure_walkthrough | PASS | PASS | n/a | PASS | n/a | n/a | PASS |
| NC2023_POLISH_CITATION_TRANSFORMER_FRAMEWORK | natcommun_2023_spad_sr_polish_v2 | citation_lookup | FAIL | FAIL | FAIL | FAIL | n/a | n/a | n/a |
| NC2023_POLISH_CITATION_PASCAL_VOC | natcommun_2023_spad_sr_polish_v2 | citation_lookup | FAIL | FAIL | FAIL | FAIL | n/a | n/a | n/a |
| NC2023_POLISH_METHOD_NETWORK_TRAINING | natcommun_2023_spad_sr_polish_v2 | method | FAIL | PASS | n/a | FAIL | n/a | n/a | n/a |
| NC2023_POLISH_FIGURE6_PANEL_B_CLAUSE | natcommun_2023_spad_sr_polish_v2 | figure_walkthrough | PASS | PASS | n/a | PASS | n/a | PASS | PASS |

## Findings
### SCINERF2024_V7_CITATION_ADMM ADMM citation in SCI decoding
- paper: `cvpr_2024_scinerf_polish_v7`
...
### Library Figure![output.pdf Fig. 3](/api/references/asset?path=F%3A%5Cresearch-papers%5C2026%5CJan%5Celse%5Ckb_chat%5Ctmp%5Creconvert_scinerf_text_polish_v7%5Cassets%5Cpage_5_fig_1.png)

*Source: output.pdf, Fig. 3. Figure
```
...
```text
The authors state in the caption of Figure 4 that the scenes shown from top to bottom are: **Cozy2room, Tanabata, Factory, and Vender**.

The exact supporting sentence is:

> **Figure 4.** Qualitative evaluations of our method against SOTA SCI image restoration methods on the synthetic dataset. Top to bottom shows the results for different scenes, including Cozy2room, Tanabata, Factory and Vender.
...
### Library Figure![output.pdf Fig. 4](/api/references/asset?path=F%3A%5Cresearch-papers%5C2026%5CJan%5Celse%5Ckb_chat%5Ctmp%5Creconvert_scinerf_text_polish_v7%
```

### NC2023_POLISH_CITATION_TRANSFORMER_FRAMEWORK Transformer framework citations
- paper: `natcommun_2023_spad_sr_polish_v2`
- family: `citation_lookup`
- status: **FAIL**
- minimum_ok: `true`
- cite_count: `0`
...
- gate_reason[citation]: `unexpected_ref_nums=[30]`
- citation_matched_ref_nums: `[30]`
- gate[locate]: `FAIL`
...
- reason: `citation:unexpected_ref_nums=[30]`
- reason: `locate:locate_missing_matching_segment`
- answer_preview:

```text
The paper cites [30] for this point.
This is stated in High-resolution single-photon imaging with physics-informed deep learning / Methods:
> The network is inspired by the Swin-Transformer structure [30], whose shift-window mechanism can effectively reduce network parameters by more than one order of magnitude compared to the conventional transformer networks [34].
```
...
```text
The paper states this explicitly in High-resolution single-photon imaging with physics-informed deep learning / Methods:
