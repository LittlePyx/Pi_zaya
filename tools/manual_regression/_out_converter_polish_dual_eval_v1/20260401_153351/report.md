...
|---|---|---|---|---|---|---|---|---|---|
| SCINERF2024_V7_CITATION_ADMM | cvpr_2024_scinerf_polish_v8 | citation_lookup | PASS | PASS | PASS | PASS | n/a | n/a | n/a |
| SCINERF2024_V7_METHOD_IMPL_ITER_BATCH | cvpr_2024_scinerf_polish_v8 | method | PASS | PASS | n/a | PASS | n/a | n/a | n/a |
| SCINERF2024_V7_FIG3_CAPTION_COMPONENTS | cvpr_2024_scinerf_polish_v8 | figure_walkthrough | PASS | PASS | n/a | PASS | n/a | n/a | PASS |
| SCINERF2024_V7_FIG4_SCENES | cvpr_2024_scinerf_polish_v8 | figure_walkthrough | PASS | PASS | n/a | PASS | n/a | n/a | PASS |
| NC2023_POLISH_CITATION_TRANSFORMER_FRAMEWORK | natcommun_2023_spad_sr_polish_v3 | citation_lookup | FAIL | PASS | FAIL | PASS | n/a | n/a | n/a |
| NC2023_POLISH_CITATION_PASCAL_VOC | natcommun_2023_spad_sr_polish_v3 | citation_lookup | FAIL | FAIL | FAIL | FAIL | n/a | n/a | n/a |
| NC2023_POLISH_METHOD_NETWORK_TRAINING | natcommun_2023_spad_sr_polish_v3 | method | FAIL | PASS | n/a | FAIL | n/a | n/a | n/a |
| NC2023_POLISH_FIGURE6_PANEL_B_CLAUSE | natcommun_2023_spad_sr_polish_v3 | figure_walkthrough | PASS | PASS | n/a | PASS | n/a | PASS | PASS |

## Findings
### SCINERF2024_V7_CITATION_ADMM ADMM citation in SCI decoding
- paper: `cvpr_2024_scinerf_polish_v8`
...
### Library Figure![output.pdf Fig. 3](/api/references/asset?path=F%3A%5Cresearch-papers%5C2026%5CJan%5Celse%5Ckb_chat%5Ctmp%5Creconvert_scinerf_text_polish_v8%5Cassets%5Cpage_5_fig_1.png)
...
### Library Figure![output.pdf Fig. 4](/api/references/asset?path=F%3A%5Cresearch-papers%5C2026%5CJan%5Celse%5Ckb_chat%5Ctmp%5Creconvert_scinerf_text_polish_v8%5Cassets%5Cpage_7_fig_1.png)

*Source: output.pdf, Fig. 4. Figure 4*
```

### NC2023_POLISH_CITATION_TRANSFORMER_FRAMEWORK Transformer framework citations
- paper: `natcommun_2023_spad_sr_polish_v3`
- family: `citation_lookup`
- status: **FAIL**
- minimum_ok: `true`
- cite_count: `0`
