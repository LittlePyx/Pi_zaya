...
|---|---|---|---|---|---|---|---|---|---|
| LSA_METHOD_REAPPLY | lsa_2026 | method | FAIL | FAIL | n/a | FAIL | n/a | n/a | n/a |
...
- gate_reason[citation]: `unexpected_ref_nums=[38, 39]`
- citation_matched_ref_nums: `[38, 39]`
- gate[locate]: `FAIL`
- gate_reason[locate]: `locate_missing_matching_segment`
- gate[quality]: `PASS`
- gate[structured_markers]: `PASS`
...
- reason: `citation:unexpected_ref_nums=[38, 39]`
- reason: `locate:locate_missing_matching_segment`
- answer_preview:

```text
The paper cites [38], [39] for this point.
This is stated in ARTICLE / Imaging biological tissue with high-throughput single-pixel compressive holography:
> This capability can also benefit a variety of applications in adaptive optics$^{38,39}$, surface contour$^{40,41}$, wavefront sensing$^{42,43}$, optical metrology$^{44–46}$, and ultrafast optics$^{47–49}$.
```
