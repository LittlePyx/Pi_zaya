    ...
    *,
    ...
    if paper_guide_mode:
        system += (
            ...
            "- Never expose SID identifiers in the user-visible answer; they are internal routing keys only.\n"
            "- Context headers may include `page:` or `pages:`; these are source-PDF page numbers. When the user asks for a page, report that value and do not claim the page is missing.\n"
        ...
        system += (
            ...
            "- Never expose SID identifiers or DOC-k labels in the user-visible answer.\n"
            "- Context header `page:` / `pages:` values are source-PDF page numbers; use them when the user asks where evidence appears.\n"
