...
_CJK_EVIDENCE_HINTS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    (
        r"(?:\u53d8\u91cf|\u53d8\u4f53)(?:\u7ea7)?\s*(?:\u4f5c\u4e3a|\u4e3a)?\s*token",
        ("variate", "variable", "token"),
    ),
    (r"\u901a\u9053\u72ec\u7acb", ("channel", "independent", "independence")),
    (r"\u81ea\u6ce8\u610f\u529b", ("self", "attention")),
    (r"\u957f\u671f\u4f9d\u8d56|\u957f\u7a0b\u4f9d\u8d56", ("long", "dependency", "dependencies")),
    (r"\u5206\u89e3", ("decomposition", "decomposed")),
    (r"\u5168\u5c40\u8f6e\u5ed3|\u5168\u5c40\u8d8b\u52bf", ("global", "profile", "trend")),
    (r"\u7ec6\u8282\u7ed3\u6784", ("detailed", "structures")),
    (
        r"\u957f\u671f(?:\u5e8f\u5217|\u65f6\u95f4\u5e8f\u5217)?\u9884\u6d4b|\u957f\u5e8f\u5217\u9884\u6d4b",
        ("long", "term", "series", "forecasting"),
    ),
    (r"\u591a\u53d8\u91cf\u957f\u671f\u9884\u6d4b", ("multivariate", "long", "term", "forecasting")),
    (r"\u591a\u53d8\u91cf", ("multivariate",)),
    (r"\u5355\u53d8\u91cf", ("univariate",)),
    (r"\u9891\u7387(?:\u57df|\u589e\u5f3a)", ("frequency", "domain", "enhanced")),
    (r"\u5085\u91cc\u53f6", ("fourier", "transform")),
    (r"\u7a00\u758f\u8868\u793a", ("sparse", "representation")),
    (r"\u8f93\u5165\u957f\u5ea6", ("input", "length")),
    (r"\u9884\u6d4b\u957f\u5ea6", ("prediction", "length")),
    (r"\u57fa\u51c6\u6570\u636e\u96c6", ("benchmark", "datasets")),
    (r"\u5c40\u90e8\u8bed\u4e49\u4fe1\u606f", ("local", "semantic", "information")),
    (
        r"\u6ce8\u610f\u529b\u56fe.{0,24}(?:\u8ba1\u7b97|\u5185\u5b58).{0,24}\u4e8c\u6b21\u65b9\u51cf\u5c11",
        ("attention", "maps", "computation", "memory", "quadratically", "reduced"),
    ),
    (r"\u5173\u6ce8.{0,8}\u66f4\u957f.{0,8}\u5386\u53f2", ("attend", "longer", "history")),
    (r"\u53d8\u91cf\u4e2d\u5fc3|\u53d8\u4f53\u4e2d\u5fc3", ("variate", "centric", "representations")),
    (r"\u65e0\u610f\u4e49.{0,8}\u6ce8\u610f\u529b\u56fe", ("meaningless", "attention", "maps")),
    (r"\u5012\u7f6e(?:\u67b6\u6784|\u7ed3\u6784)?", ("inverted", "architecture")),
    (r"\u53d8\u91cf\u76f8\u5173\u6027", ("multivariate", "correlations")),
    (r"\u5e8f\u5217\u8868\u793a", ("series", "representations")),
    (
        r"\u672a\u6765.{0,20}\u63a2\u7d22.{0,20}\u9884\u8bad\u7ec3",
        ("future", "explore", "pretraining"),
    ),
    (r"\u81ea\u76d1\u7763\u8868\u793a\u5b66\u4e60", ("self", "supervised", "representation", "learning")),
    (r"\u591a\u5468\u671f", ("multi", "periodicity")),
    (r"\u5468\u671f\u5185", ("intraperiod",)),
    (r"\u5468\u671f\u95f4", ("interperiod",)),
    (r"\u63d2\u8865", ("imputation",)),
    (r"\u5206\u7c7b", ("classification",)),
    ...
    (r"奈奎斯特", ("nyquist", "sampling", "criterion")),
    (
        r"整数个(?:拍频|差频)周期|(?:拍频|差频)周期.{0,8}整数个",
        ("integer", "number", "beating", "cycles", "displayed", "pattern"),
    ),
    (r"反射光(?:场|电场)?", ("reflected", "electric", "fields")),
    (r"散射光(?:场|电场)?", ("scattered", "electric", "fields")),
    (r"折射率", ("refractive", "index", "medium")),
    (r"轴向位置", ("axial", "position", "scatterer")),
    (r"照明波长|波长", ("illumination", "wavelength")),
